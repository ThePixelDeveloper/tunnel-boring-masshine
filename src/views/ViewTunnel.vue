        ...
        <div class="flex flex-col overflow-y-auto h-screen">
            ...
            <div class="bg-gray-200 px-5 text-white h-10 flex row">
                ...
                <div class="flex flex-row-reverse items-center flex-grow">
                    <router-link tag="button" :to="{ name: 'Edit Tunnel', params: { id: tunnel.id }}" class="font-medium text-xs shadow rounded py-1 px-5 bg-gray-100 text-blue-500">Update</router-link>
