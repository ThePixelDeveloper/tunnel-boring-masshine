                ...
                <div class="flex-row mt-2">
                    <ul class="list-inside list-disc text-red-600">
                        <li class="text-red-600 text-sm"
                            v-if="!$v.tunnel.rules.$each.$iter[i].local.address.required && $v.tunnel.rules.$each.$iter[i].local.address.$error">
                            A local address is required.
                        </li>
                        <li class="text-red-600 text-sm"
                            v-if="!$v.tunnel.rules.$each.$iter[i].local.port.required && $v.tunnel.rules.$each.$iter[i].local.port.$error">
                            A local port is required.
                        </li>
                        <li class="text-red-600 text-sm"
                            v-if="!$v.tunnel.rules.$each.$iter[i].target.address.required && $v.tunnel.rules.$each.$iter[i].target.address.$error">
                            A target address is required.
                        </li>
                        <li class="text-red-600 text-sm"
                            v-if="!$v.tunnel.rules.$each.$iter[i].target.port.required && $v.tunnel.rules.$each.$iter[i].target.port.$error">
